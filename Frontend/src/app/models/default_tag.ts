...
export const DEFAULT_TAGS: Tag[] = [
  ...
  { id: 4, label: 'Chinesisch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },
  { id: 5, label: 'Deutsch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },
  { id: 6, label: 'Indisch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },
  { id: 7, label: 'Italienisch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },
  { id: 8, label: 'Japanisch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },
  { id: 9, label: 'Koreanisch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },
  { id: 10, label: 'Mexikanisch', count: 0, selected: false, type: TagType.LANDESKÜCHE, disabled: false },

...
export const DEFAULT_TAGS: Tag[] = [
  ...
  { id: 12, label: 'fleischhaltig', count: 0, selected: false, type: TagType.ERNÄHRUNGSWEISE, disabled: false },
  { id: 13, label: 'fischhaltig', count: 0, selected: false, type: TagType.ERNÄHRUNGSWEISE, disabled: false },
  { id: 14, label: 'vegan', count: 0, selected: false, type: TagType.ERNÄHRUNGSWEISE, disabled: false },
  { id: 15, label: 'vegetarisch', count: 0, selected: false, type: TagType.ERNÄHRUNGSWEISE, disabled: false },
];
